...
resource "oci_core_service_gateway" "service_gateway" {
    ...
    services {
        #Required
   	   service_id =  data.oci_core_services.dev_services.services.0.id
    }
    vcn_id = local.Project_vcn_id
...
resource "oci_database_autonomous_database" "dev_autonomouas_db" {
    #Required
	...
	data_storage_size_in_tbs=var.database_storage_tb
