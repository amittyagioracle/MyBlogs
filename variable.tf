...
variable "database_db_name" {
  type        = string
  description = "provide value of Database Name"
}
...
variable "database_storage_tb" {
  type        = string
  description = "provide value of Database Storage in Tb"
}
...
variable "database_cpu_core_count" {
  type        = string
  description = "provide value of cpu core Count"
}
## OAC
...
variable "pac_dns_zone" {
  type        = string
  description = "provide Dns zone for PAC"
}

variable "oac_pac_domain_suffix" {
  type        = string
  description = "provide domain suffix for PAC"
}
## Bastion Compute
